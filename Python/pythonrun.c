...
#define PARSER_FLAGS(flags) \
    ((flags) ? ((((flags)->cf_flags & PyCF_DONT_IMPLY_DEDENT) ? PyPARSE_DONT_IMPLY_DEDENT : 0) | ((flags)->cf_flags & CO_FUTURE_WITH_STATEMENT ? PyPARSE_WITH_IS_KEYWORD : 0)) : 0)
#endif
    ...
    _PyErr_Display(PyObject *file, PyObject *exception, PyObject *value, PyObject *tb)
    {
        ...
        PyObject *seen;
        if (PyExceptionInstance_Check(value) && tb != NULL && PyTraceBack_Check(tb))
        {
